...
//	ServiceDetails serviceDetails;
	...
	public Map<Long, Service> getServiceMap() {
		...
		List<ServiceInstance> instances = discoveryClient.getInstances("services management");  //services management
		RestTemplate restTemplate = new RestTemplate();

		String url = instances.get(0).getUri().toString()+"/servicesDetails";
